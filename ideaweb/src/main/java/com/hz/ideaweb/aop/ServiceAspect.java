...
public class ServiceAspect {
     ...
     */
    @Pointcut("execution(public * com.hz.ideaweb.server.impl.*.*(..))")
    ...
    public void afterThrowingMethod(JoinPoint joinPoint,Exception ex){
        ...
        System.out.println("======AOP server=========this method "+methodName+" end.ex message<"+ex+">");
    }
    ...
    */
    ...
    private void systemOutJoinPoint(JoinPoint joinPoint){
        ...
        System.out.println("====================Service aop end=====================");
    }
}
